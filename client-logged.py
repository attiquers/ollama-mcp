...
async def main():
    ...
    model = ChatOllama(
        model="qwen3:1.7b",
        system_prompt="You are a helpful assistant. Always return tool outputs directly without extra reasoning dont try be smart. If tool says X you say X too. If tool says 10 you say 10 too."
    )
